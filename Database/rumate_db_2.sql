...
CREATE DATABASE rumate_db_2 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE PERSONAS (
    ...
    barrio_persona VARCHAR(40) NOT NULL,
    calle_persona VARCHAR(40) NOT NULL,
    numero_persona VARCHAR(40) NOT NULL,
...
CREATE TABLE LOTES (
    ...
    FOREIGN KEY (id_usuario_lote) REFERENCES USUARIOS(id_usuario),
...
-- Crear la tabla PUJAS_DE_USUARIOS
CREATE TABLE PUJAS_DE_USUARIOS (
    ...
    FOREIGN KEY (id_usuario_puja_de_usuario) REFERENCES USUARIOS(id_usuario)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
