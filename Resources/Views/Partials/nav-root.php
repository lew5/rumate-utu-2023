...
<nav class="navigation__menu f-row align-center">
  ...
  <a href="<?= PUBLIC_PATH ?>/root/empleados" class="menu-link"><svg
      xmlns="http://www.w3.org/2000/svg"
      class="icon icon-tabler icon-tabler-user-star" width="24" height="24"
      viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
      stroke-linecap="round" stroke-linejoin="round">
      <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
  ...
  <a href="<?= PUBLIC_PATH ?>/perfil/<?= $navUsuario->getId(); ?>"
    ...
    <img class="nav-profile"
      src="<?= PUBLIC_PATH ?>/Public/imgs/Usuario/<?= $navUsuario->getImagen() ?>.webp">
  </a>
</nav>